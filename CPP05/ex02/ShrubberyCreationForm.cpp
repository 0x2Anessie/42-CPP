...
{
	std::cout << GREEN_BOLD << "ShrubberyCreationForm copy constructor" << std::endl;
}
...
ShrubberyCreationForm &ShrubberyCreationForm::operator=(ShrubberyCreationForm const &other)
{
	if(this != &other)
	{
		...
		target = other.target;
		std::cout << GREEN_BOLD << "ShrubberyCreationForm assignation operator" << std::endl;
	}
	return *this;
}
...
{
	std::cout << RED_BOLD << "ShrubberyCreationForm destructor" << std::endl;
}
